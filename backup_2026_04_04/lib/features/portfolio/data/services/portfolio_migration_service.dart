...
class PortfolioMigrationService {
  ...
  PortfolioMigrationService({FirebaseFirestore? firestore})
      : _firestore = firestore ?? FirebaseFirestore.instance;

  Future<Map<String, dynamic>> migratePortfolioData() async {
    final projects = _getHardcodedProjects();
    int successCount = 0;
    int failCount = 0;
  ...
  List<Map<String, dynamic>> _getHardcodedProjects() {
    ...
    return [
      {
        ...
        'category': 'Mobile App',
        'description':
            'AIA 생명 앱 Phase2 고령자 전용 모드 메인 UX 기획 및 디자인 시스템 구축. 보험료 납입, 보험계약대출 상환, 자동부활 신청, 자동송금 신청 등 핵심 GUI 정의. 디자인 개발 완성률 100%, 프로젝트 일정 준수율 100% 달성.',
        'tags': ['Figma', 'Mobile UX', 'Design System', 'Accessibility'],
        'gradientColors': ['#00BCD4', '#2196F3'],
      ...
      },
      {
        ...
        'category': 'Web Design',
        'description':
            '토지개발 분석 플랫폼 UX/UI 기획 및 디자인 방향 수립, 디자인 시스템 설계. 반응형 웹 구현으로 PC/태블릿/모바일 대응.',
      ...
      },
      {
        ...
        'category': 'IoT Device',
        'description':
            '동종 업계 1위 유지 기반 HT 안드로이드 월패드 라인업 UX 설계 프로세스 체계화. 현대/포스코/금호/한양/한화/대림 등 고객사 맞춤형 월패드(7~24인치) UX/UI 기획 및 통합 디자인 시스템 적용. 디자인 개발 완성률 100%, 프로젝트 일정 준수율 100%.',
      ...
      },
      {
        ...
        'category': 'Mobile App',
        'description':
            'HT HOME 및 HT Imazu 앱 앱스토어 정식 론칭. 월패드와 통합 연동 최적화 및 사용자 접점 확대. 스마트홈 IoT 기기 통합 제어 UX 설계.',
        'tags': [
          'Figma',
          'Adobe XD',
          'iOS',
      ...
      },
      {
        ...
        'category': 'Web Design',
        'description':
            '클로저스 CBT 반응형 웹사이트 UX/UI 개발. NEXON 사내 최초로 PC/태블릿/모바일 대상 반응형 웹 구현 적용.',
        'tags': [
          'Responsive Web',
          'HTML/CSS',
          'Game Promotion',
