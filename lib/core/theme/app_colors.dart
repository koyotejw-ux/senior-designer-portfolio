...
class AppColors {
  ...
  // Dark Background Palette (Deep Space)
  static const Color deepSpace = Color(0xFF020205); // Deepest black-blue
  static const Color darkNavy = Color(0xFF050810);
  static const Color charcoal = Color(0xFF0A101A);
  static const Color slate = Color(0xFF151A25);
  ...
  static const Color networkLine = Color(
    0x33009DDC,
  ); // Accent cyan with opacity
  ...
  static const Color glowingCyan = Color(0xFF00E5FF); // Bright cyan for glows
