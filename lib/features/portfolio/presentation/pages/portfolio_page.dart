...
class _PortfolioPageState extends ConsumerState<PortfolioPage>
  ...
  final List<String> _categories = [
      ...
      final List<Map<String, dynamic>> _projects = [
    {
      ...
      'mainScreenImages': ['assets/images/sam_mes_final_final.jpg'],
      'details': {
        ...
        'technologies': ['플랫폼: WEB 반응형', 'Figma', 'Enterprise', 'Dashboard'],
      },
    },
    {
      'id': 'p7',
      ...
      'details': {
        ...
        'achievements': [
          '토지개발 실시간 분석 대시보드 UI 설계',
          '분석 정보 필터 및 데이터 매핑 사용자 시나리오 정의',
          '데이터 수집 및 통계 시각화 구현',
          '사용자 필드 테스트 피드백 반영 사용성 개선',
        ],
        'technologies': ['플랫폼: WEB 반응형', 'Dashboard', 'Design System', 'Figma'],
      },
    },
    {
      'id': 'p1',
      ...
      'details': {
        ...
        'technologies': ['플랫폼: AOS/iOS APP & WEB', 'Figma', 'Design System', 'Accessibility'],
      },
    },
    {
      'id': 'p2',
      ...
      'details': {
        ...
        'technologies': ['플랫폼: 안드로이드 CUSTOM OS', 'Figma', 'Design System', 'IoT UI/UX'],
      },
    },
    {
      'id': 'p3',
      ...
      'details': {
        ...
        'technologies': ['플랫폼: AOS/iOS APP', 'Smart Home', 'iOS & Android'],
      },
    },
    {
      'id': 'p4',
      ...
      'details': {
        ...
        'technologies': ['플랫폼: AOS/iOS (UNITY3D)', 'Game UI', 'Photoshop'],
      },
    },
    {
      'id': 'p5',
      ...
      'details': {
        ...
        'technologies': ['플랫폼: 반응형 웹', 'Game Promotion', 'HTML/CSS'],
      },
    },
    {
      'id': 'p6',
      ...
      'details': {
        ...
        'technologies': ['플랫폼: 웹', 'Promotion', 'HTML/CSS', 'Photoshop'],
      },
    }
  ];
